...
// access. Callers combine denormalized trailing state with the resuming turn's
// gitBranch/files_touched/resumeMarkerBefore, keeping
...
export interface SegmentBoundaryInput {
    ...
    // The resuming turn's own git branch, or null if unavailable. Codex has no per-turn branch.
    ...
    // Whether a Codex <environment_context> marker immediately preceded the turn.
...
// capture, and the Codex fallback rule ("no cut
