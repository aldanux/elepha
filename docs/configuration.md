...
| `capture-opencode`    | `true`, `false`, `1`, `0`, `on`, `off` | `false`  | Controls capture of OpenCode sessions. At least one capture tool must remain enabled. Restart the capture service after changing it.                                                                                |
