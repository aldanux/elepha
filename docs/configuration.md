...
| `capture-kimi`        | `true`, `false`, `1`, `0`, `on`, `off` | `true`   | Controls capture of Kimi Code sessions. At least one capture tool must remain enabled. Restart the capture service after changing it.                                                                            |
